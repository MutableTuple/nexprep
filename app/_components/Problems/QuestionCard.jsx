...
export default function QuestionCard({
  ...
  return (
    <button
      onClick={onClick}
      className="group w-full rounded-3xl border border-neutral-200 bg-white p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:border-neutral-300 hover:shadow-lg"
    >
      {/* Header */}
      ...
      <h2 className="mt-5 text-xl font-bold tracking-tight text-neutral-900 group-hover:text-black">
        {title}
      </h2>
