...
const TITLE = "BITSAT Practice Questions";
const DESCRIPTION =
  "Practice BITSAT exam questions across Physics, Chemistry, and Maths. Filter by subject and difficulty, and solve with instant XP and streak tracking.";
...
export default async function Page({ searchParams }) {
  ...
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    name: TITLE,
    url: "https://rankgrind.com/bitsat",
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
        {
