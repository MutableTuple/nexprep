...
const TITLE = "JEE Advanced Practice Questions";
const DESCRIPTION =
  "Practice JEE Advanced exam questions across Physics, Chemistry, and Maths. Filter by subject and difficulty, and solve with instant XP and streak tracking.";
...
export async function generateMetadata({ searchParams }) {
  ...
  return {
    ...
    alternates: { canonical: "/jee-advanced" },
    openGraph: { title: TITLE, description: DESCRIPTION, url: "/jee-advanced" },
...
export default async function Page({ searchParams }) {
  ...
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    name: TITLE,
    url: "https://rankgrind.com/jee-advanced",
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://rankgrind.com" },
        { "@type": "ListItem", position: 2, name: EXAM, item: "https://rankgrind.com/jee-advanced" },
      ],
    },
  };
